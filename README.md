...
|:--------:|:---------:|:----------:|:-------:|:-------------:|
| 0 | [libft](https://github.com/maitreverge/libft) | [![My Skills](https://skillicons.dev/icons?i=c)](https://skillicons.dev) | ![libft grade](https://img.shields.io/badge/:-125%25-success?style=flat-square&logo=42) | `libft` is a basic C static-library built from scratch, which mimics about 50 core functions of C Standard Library. |
||||||
| 1 | [ft_printf](https://github.com/maitreverge/ft_printf) | [![My Skills](https://skillicons.dev/icons?i=c)](https://skillicons.dev) | ![printf grade](https://img.shields.io/badge/:-125%25-success?style=flat-square&logo=42) | `ft_printf` is a `printf` C function made from scratch. |
...
||||||
| 2 | [pipex](https://github.com/maitreverge/pipex) | [![My Skills](https://skillicons.dev/icons?i=c,linux)](https://skillicons.dev) | ![pipex grade](https://img.shields.io/badge/:-125%25-success?style=flat-square&logo=42) |  `pipex` simulates a shell command pipeline, connecting inputs and outputs between shell commands. |
